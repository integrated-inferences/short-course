...
* describe a query that depends on an controlled change in some variable 
* describe a query that depends on a natural (observational) change in some variable 
...
Independently there is 50% chance that $B$ causes $C$ for a given unit.
