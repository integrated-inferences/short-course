...
2. Formally using `CausalQueries`.  See the [queries handout]("queries_handout.pdf") for examples. Be sure to distinguish between *controlled*  interventions (using `[X=...]`) and simple conditioning (using "given..."). 
...
# Part II: A causal chain (30 mins)
...
# Additional (if you have time!): Bayesian sequencing and posterior variance (30 mins)
