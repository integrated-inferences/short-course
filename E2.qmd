...
2. Formally using `CausalQueries`.  See the queries handout for examples. Be sure to distinguish between *controlled*  interventions (using `[X=...]`) and simple conditioning (using "given..."). 
