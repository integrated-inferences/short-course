tips <- list(
  ...
  causal_statement = "A causal statement uses bracket syntax for interventions, e.g. Y[X=1] > Y[X=0].",
  ...
  query = "A query is a causal question. Examples: Y[X=1] - Y[X=0], Y[X=1] > Y[X=0], Y[X=1]==1.",
