...
# Basic Setup: Process Tracing with a DAG

## Start with a DAG: Inequality and Democratization (through Mobilization)
...
* The DAG tells us nothing about the *direction* of effects
* Inequality might boost or depress mobilization
* Mobilization might encourage or delay democratization (maybe it just leads to more repression)
...
## Process tracing as collecting *additional* information about a case
...
* So we collect *more* information about the case to help figure that out
...
# Why the DAG alone is not enough

## What does $M=1$ actually tell us?
...
* Which $M$ value is *more* consistent with $I=1$ causing $D=1$?
    * Mobilization occurring? or
    * Mobilization not occurring?


## Maybe $M=0$ is more consistent with causation here
...
## Maybe $M=1$ is more consistent with causation here
...
## Our inference from $M$ depends on "thicker" beliefs about causal effects
...
* Our inferences about a *case* always depend on theory
    * On our beliefs about how the world works *generally*
...
## An important implication of Bayesian reasoning {.smaller}
...
## An important implication of Bayesian reasoning
...
* In book, some rules about when nodes are **potentially** informative
