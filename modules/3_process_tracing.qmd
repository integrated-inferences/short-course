...
So, for instance: *if* you believe this model, then seeing $M$ should tell you something about a query regarding the $X$, $Y$ relationship. (What might the query be? where would it sit on the DAG?)
