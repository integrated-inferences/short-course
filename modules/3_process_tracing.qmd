...
Simple insight: *If* you believe this model, then seeing $M$ should tell you something about a query regarding the $I$, $D$ relationship.

*If there was no mobilization then inequality didn't cause the transition*
...
* For this you need an *informative* **causal model**
