...
$$
note: we assumed here that the assignment of $X$ is independent of potential outcomes; can you see where?^[here: $\Pr(X=1, Y=1|\theta^Y_{01}) = \Pr(Y=1|\theta^Y_{01}, X=1)\Pr(X=1 | \theta^Y_{01})=\Pr(X=1 | \theta^Y_{01})$]
