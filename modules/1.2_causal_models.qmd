...
## $\theta$ terms: random disturbances
...
* For us: these will capture  the *way* a "child" responds to its parents
...
* formally this involves a specification of the $\theta$s. The $\theta$s can be used to indicate *how* a given child reacts to a parents value
...
* You refine a model by specificying  which types are possible or which types are *likely*
