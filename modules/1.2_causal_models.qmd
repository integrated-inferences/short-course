...
A specific *argument* about how things work in a case might look go: 
...
* The $\theta$'s indicate how a node *responds* to its "parents"
* Process tracing is: figuring out what the theta's are for a case.
